...
for ($i=0;$i<count($retdj);$i++){
    ...
    if ($djsum>0){
        ...
        $djhtml .="[$hangshu]<a href='?cmd=$chakandj'>{$djname}x{$djsum}</a><a href='?cmd=$maichu1'>卖出1</a>
		<!--<a href='?cmd=$maichu5'>卖出5</a><a href='?cmd=$maichu10'>卖出10</a>-->
		<br/>";
    }
...
$bagdjhtml =<<<HTML
[<font size="2"><a href="?cmd=$getbagzbcmd">装备</a>|道具|<a href="?cmd=$getbagypcmd">药品</a>|<a href="?cmd=$getbagjncmd">技能</a><a href="?cmd=$getbagydcmd">丹药</a></font>]<br>
<br/>
$djhtml
<br/>
